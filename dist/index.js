...
// src/print_cpcl.js
var print_cpcl_exports = {};
__export(print_cpcl_exports, {
  default: () => PrintCPCL
});
var import_iconv_lite, PrintCPCL;
var init_print_cpcl = __esm({
  "src/print_cpcl.js"() {
    import_iconv_lite = __toESM(require_lib());
    init_qrcode();
    PrintCPCL = class _PrintCPCL {
      static PADDING_TOP = 40;
      constructor({ width = 72, height = 40 } = {}) {
        this.width = width * 8;
        this.height = height * 8;
        this.qty = 1;
        this.currentY = _PrintCPCL.PADDING_TOP;
        this.data = [];
      ...
      text_big(data, { size = 1, ...options } = {}) {
        ...
        this.text(data, { size, y: 36 * size, ...options });
        this.#pushData("SETMAG 0 0");
        this.#pushData("SETBOLD 0");
      }
      qrcode_right(data, { y = _PrintCPCL.PADDING_TOP, u = 6 } = {}) {
        const qrcodeEncoder = qrcode_default(4, "M");
      ...
      image(dataArray, { x = 0, meta = {} } = {}) {
        const imgData = dataArray.map((i) => {
          return i.toString(16).padStart(2, "0").toUpperCase();
        }).join("");
        this.data.push(
          ...import_iconv_lite.default.encode(`CG ${meta.byteWidth} ${meta.height} ${x} ${this.currentY} `, "gb18030"),
          ...dataArray,
          ...import_iconv_lite.default.encode("\r\n", "gb18030")
        );
      ...
      #pushData(...value) {
        value.forEach((i) => {
          this.data.push(...import_iconv_lite.default.encode(`${i}\r
`, "gb18030"));
        });
      }
    };
...
// src/print_pos.js
var print_pos_exports = {};
__export(print_pos_exports, {
  default: () => PrintPOS
});
var import_iconv_lite2, PrintPOS;
var init_print_pos = __esm({
  "src/print_pos.js"() {
    import_iconv_lite2 = __toESM(require_lib());
    PrintPOS = class _PrintPOS {
      static TXT_NORMAL = [27, 33, 0];
      constructor() {
        this.data = [];
        this.debug = false;
      ...
      text_big(value) {
        ...
        this.data.push(...import_iconv_lite2.default.encode(value, "gb18030"));
        this.data.push(..._PrintPOS.TXT_NORMAL);
        this.data.push(10);
      }
      text(value) {
        this.data.push(..._PrintPOS.TXT_NORMAL);
      ...
      qrcode(value) {
        const bytes = import_iconv_lite2.default.encode(value, "gb18030");
        const qrSize = [29, 40, 107, 3, 0, 49, 67, 6];
        const qrErr = [29, 40, 107, 3, 0, 49, 69, 48];
        const qrData = [29, 40, 107, bytes.length + 3, 0, 49, 80, 48];
        const qrRun = [29, 40, 107, 3, 0, 49, 81, 48];
        this.data.push(
          ...qrSize,
          ...qrErr,
          ...qrData,
      ...
      barcode(value, { pos = 2, height = 50, width = 2, format = 4 } = {}) {
        const bytes = import_iconv_lite2.default.encode(value, "gb18030");
        const barPostion = [29, 72, pos];
        const barHeight = [29, 104, height];
        const barWidth = [29, 119, width];
        const barFormat = [29, 107, format];
        this.data.push(
          ...barPostion,
          ...barHeight,
          ...barWidth,
...
// src/print_pic.js
var print_pic_exports = {};
__export(print_pic_exports, {
  default: () => PrintPic
});
var PrintPic;
var init_print_pic = __esm({
  "src/print_pic.js"() {
    PrintPic = class {
      constructor(dpr, img) {
        this.dpr = dpr || 1;
...
// index.js
var PrintCPCL2 = (init_print_cpcl(), __toCommonJS(print_cpcl_exports));
var PrintPOS2 = (init_print_pos(), __toCommonJS(print_pos_exports));
var PrintPic2 = (init_print_pic(), __toCommonJS(print_pic_exports));
module.exports = {
  PrintCPCL: PrintCPCL2,
  PrintPOS: PrintPOS2,
  PrintPic: PrintPic2
};
